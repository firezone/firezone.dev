...
resource "vultr_dns_record" "google-ext-txt-1" {
  domain = vultr_dns_domain.firezone-dev.id
...
resource "vultr_dns_record" "google-ext-txt-2" {
  domain = vultr_dns_domain.firezone-dev.id
  name = "ext"
  type = "TXT"
...
resource "vultr_dns_record" "google-external-txt-1" {
  domain = vultr_dns_domain.firezone-dev.id
...
resource "vultr_dns_record" "google-external-txt-2" {
  domain = vultr_dns_domain.firezone-dev.id
  name = "external"
  type = "TXT"
  data = "v=spf1 include:_spf.google.com ~all"
